...
public class Messages {
    private static Map<String, ResourceBundle> rbBundles = new ConcurrentHashMap<String, ResourceBundle>();
    private static Map<String, Map<String, MessageFormat>> rbFormats = new ConcurrentHashMap<String, Map<String, MessageFormat>>();
    ...
    protected void init() {
        ...
        final ResourceBundle rb = rbBundles.get(resourceName);
        if (rb == null) {
            try {
                if (locale == null) {
            ...
            rbBundles.put(resourceName, messages);
            rbFormats.put(resourceName, formats);
        } else {
            messages = rb;
            formats = rbFormats.get(resourceName);
        }
    }
